                            ...
                            @if ($schedule)
                                @php
                                    ...
                                    $filledSlots = collect($times)
                                        ...
                                        ->toArray();
                                @endphp
                                <td colspan="{{ $colspan }}" class="border border-neutral-200 dark:border-neutral-700 bg-green-100 dark:bg-green-900 w-8 cursor-pointer" wire:click="editSchedule('{{ $date }}', '{{ $worker->id }}', '{{ $time }}')">
...
{{-- EDIT --}}
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/70 backdrop-blur-sm transition-all">
        <div class="relative bg-white dark:bg-neutral-900 p-6 rounded-xl shadow-2xl w-full max-w-md mx-4">
            <button wire:click="$set('showModal', false)" class="absolute top-3 right-3 text-gray-400 hover:cursor-pointer dark:text-gray-300 hover:text-gray-700 dark:hover:text-white transition" aria-label="Tutup">&times;</button>
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200">Status Pengerjaan</label>
                <select wire:model.defer="editStatus" class="border border-neutral-200 dark:border-neutral-700 rounded w-full px-3 py-2 bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-300" >
            ...
            <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                Durasi sekarang: {{ $editDuration }} menit
            </div>
            <div class="mb-6">
            ...
            <div class="flex justify-end gap-2">
                <button wire:click="$set('showModal', false)" class="px-4 py-2 bg-gray-200 hover:cursor-pointer dark:bg-neutral-800 text-gray-700 dark:text-gray-200 rounded hover:bg-gray-300  dark:hover:bg-neutral-700 transition">Batal</button>
                <button wire:click="updateSchedule" class="px-4 py-2 bg-blue-600 hover:cursor-pointer dark:bg-blue-700 text-white rounded hover:bg-blue-700 dark:hover:bg-blue-800 transition font-semibold">
                    Simpan
